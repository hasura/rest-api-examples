...
let EmployeeController = class EmployeeController extends tsoa_1.Controller {
     ...
     */
    getEmployees(limit = 20, offset = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, db_1.default)('Employee')
                .select()
                .limit(limit)
                .offset(offset)
    ...
    getEmployee(EmployeeId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield (0, db_1.default)('Employee').first().where({ EmployeeId });
            if (!result) {
     ...
     */
    insertEmployee(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield (0, db_1.default)('Employee').insert(requestBody).returning('*');
            return result[0];
        });
    }
    /**
    ...
    updateEmployee(EmployeeId, requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield (0, db_1.default)('Employee')
                .where({ EmployeeId })
                .update(requestBody)
                .returning('*');
            return result[0];
...
], EmployeeController.prototype, "insertEmployee", null);
__decorate([
    (0, tsoa_1.Patch)('{EmployeeId}'),
    __param(0, (0, tsoa_1.Path)()),
